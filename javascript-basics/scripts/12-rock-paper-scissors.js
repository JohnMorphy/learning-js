...
document.querySelector('.js-rock-button').addEventListener('click', () => fight('Rock'));
document.querySelector('.js-paper-button').addEventListener('click', () => fight('Paper'));
document.querySelector('.js-scissors-button').addEventListener('click', () => fight('Scissors'));
